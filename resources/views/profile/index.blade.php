...
<div class="container-fluid">
	...
	<div class="dashboard">
		<div class="advertisment-banner1 col-md-12">
			<img src="images/banner/e-bg.jpg" alt="" title="">
		</div>
		<div class="main-page">
			<div class=" dash-profile">
				<img src="{{url('images/profile/',$user->image)}}" width="110%" alt="">
			</div>
			<div class="prompr">
				<ul class="pull-right prof">
					<li class="number"><i class="fa fa-phone" aria-hidden="true"></i> &nbsp; +{{$user->number}}
					</li>
					<li class="number"><i class="fa fa-map-marker" aria-hidden="true"></i> &nbsp; Birth: {{$user->bith}}
					</li>

				</ul>
				<div class="dashname">
					{{$user->name}}
					<p>@ {{$user->email}} | {{$user->gender->name}}</p>
				</div>
				<div class="liked1">
					<div class="promote">
